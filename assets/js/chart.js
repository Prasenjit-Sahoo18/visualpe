...
const pl1=[
  ...
  const logout=()=>{
    ...
    window.location.href="https://ankushsaha18.github.io/VisualPe/login.html"
  }
  var jwt=localStorage.getItem("jwt")
  if(jwt==null)window.location.href="https://ankushsaha18.github.io/VisualPe/login.html"
    ...
    .then((resp)=>{
            {
               console.log(resp)
               if(resp.wait==true)
               window.location.href="https://ankushsaha18.github.io/VisualPe/wait.html"
               if(resp.auth==false)
               window.location.href="https://ankushsaha18.github.io/VisualPe/login.html"
            }
        })
